...
public class ArmyQuality {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nAre you a resident");
        //I need to get info and assign to variable isResident
        ...
        if ((hasCitizenship || isResident) && (age >= 18 && age <= 35) && hasDiploma) {
            System.out.println("Are you qualified for the army");
        } else {
            if (!hasCitizenship && !isResident) {
                System.out.println("Ypu must be citizen or a resident");
            }
            if (age < 18 | age > 35) {
