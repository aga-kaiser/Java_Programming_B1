...
use the following data to help you determine the number of days in each month:
    ...
    -- Write a code that base on the month number --> it says how many days it has
...
//        Month that has 28 days: 2
        ...
        boolean has31Days = (monthNUmber == 1 || monthNUmber == 3 || monthNUmber == 5 || monthNUmber == 7 || monthNUmber == 8 ||
        ...
        if (has31Days){
            System.out.println("This month has 32 days");
        }
